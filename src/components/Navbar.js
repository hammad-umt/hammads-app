  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <button type="button" class="btn btn-primary"onClick={props.pinkMode}>Enable Pink Mode</button> 
    </div>
    <div className={`form-check form-switch ms-auto text-${props.mode==='light'?'dark':'light'}`}>
    <button type="button" class="btn btn-primary"onClick={props.toggleMode}>Enable Dark Mode</button> 
    </div>
    </div>
  </div>
</nav>
